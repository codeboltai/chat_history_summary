...
// COMMIT
 let commit_system = `You are an expert software engineer.
...
// COMMANDS
let undo_command_reply = `I did \`git reset --hard HEAD~1\` to discard the last edits. Please wait for further
instructions before attempting that change again. Feel free to ask relevant questions about
why the changes were reverted.`;

let added_files = `I added these files to the chat: {fnames}.
...
let run_output = `I ran this command:
...
// CHAT HISTORY
let summarize = `*Briefly* summarize this partial conversation about programming.
...
let summary_prefix = "I spoke to you previously about a number of things.\n";
